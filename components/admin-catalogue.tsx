...
export function AdminCatalogue() {
  ...
  const [niches, setNiches] = useState<StyleName[]>(["Streetwear", "Skate", "Y2K"]);
  const [count, setCount] = useState(4);
  const [withAds, setWithAds] = useState(true);
  const [brandName, setBrandName] = useState("");
  const [brandNiche, setBrandNiche] = useState<StyleName>("Streetwear");
  const [brandLocation, setBrandLocation] = useState("");
  const [brandImage, setBrandImage] = useState("");
  const [productName, setProductName] = useState("");
  const [productLabel, setProductLabel] = useState("");
  const [productPrice, setProductPrice] = useState("90");
  const [productStyle, setProductStyle] = useState<StyleName>("Streetwear");
